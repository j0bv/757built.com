class UpdateChecker {
    constructor() {
        ...
        https.get({
            protocol: "https:",
            host: "api.github.com",
            path: "/repos/GitSquared/757built-ui/releases/latest",
            headers: {
                "User-Agent": "757built-UI UpdateChecker"
            }
        }, res => {
                    ...
                    try {
                        ...
                        if (release.tag_name.slice(1) === current) {
                            ...
                            new Modal({
                                ...
                                message: `757built-UI <strong>${release.tag_name}</strong> is now available.<br/>Head over to <a href="#" onclick="require('electron').shell.openExternal('${release.html_url}')">github.com</a> to download the latest version.`
                            });
